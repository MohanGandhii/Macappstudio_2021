...
header1 += '<a class="logoheader" href="../index"><img src="images/logo.png" alt="macappstudio"/></a>';
...
header1 +='<a class="smoothScroll Get_Proposal typeform-share" href="https://tally.so/r/xXyRrd" data-mode="popup"><span class="login" id="get_proposal"><span>Get a Proposal</span></span></a>';
header1 +='</div>';
header1 +='</div>';
...
header1 +='</ul>';
header1 +='</div>'; 
header1 +='<a class="smoothScroll Get_Proposal header_menu_Get_Proposal_btn typeform-share" href="https://tally.so/r/xXyRrd" data-mode="popup"><span class="login" id="get_proposal"><span>Get a Proposal</span></span></a>';
header1 += '</div>';
header1 += '</div>';
...
footer +='	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_zero">';
footer +=' 		 <a href="../index"><img src="images/logo.png" class="logofooter" alt=""></a>';
footer +='	</div>';
