      ...
      <div className="max-w-[1360px] mx-auto px-6">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 w-full relative z-10">
            ...
            {/* Left Column: With Extended Tech Team */}
            <div className="flex flex-col gap-4 relative">
              ...
              <div className="relative">
                <motion.div
                  ...
                  className="bg-white border border-[#E5E7EB] rounded-[24px] p-6 sm:p-10 shadow-[0_20px_50px_rgba(16,185,129,0.08)] relative overflow-hidden text-left"
                >
            ...
            {/* Right Column: Traditional Hiring */}
            <div className="flex flex-col gap-4 relative">
              ...
              <motion.div
                whileHover={{ scale: 1.005 }}
                className="bg-white border border-[#E5E7EB] rounded-[24px] p-6 sm:p-10 shadow-[0_20px_50px_rgba(59,130,246,0.08)] relative overflow-hidden text-left h-full flex flex-col justify-start"
              >
