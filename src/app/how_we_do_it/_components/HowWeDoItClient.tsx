...
import HeroSection              from "./01_HeroSection";
import PromisesSection          from "./02_PromisesSection";
import QuoteSection             from "./03_QuoteSection";
import HelpStagesSection        from "./04_HelpStagesSection";
import StorySection             from "./05_StorySection";
import ProcessSection           from "./06_ProcessSection";
import DeliveryFlowchartSection from "./07_DeliveryFlowchartSection";
import PricingSection           from "./08_PricingSection";
import WorldClassSection        from "./09_WorldClassSection";
import PaymentSection           from "./10_PaymentSection";
import PaymentMilestonesSection from "./11_PaymentMilestonesSection";
import ModelsSection            from "./12_ModelsSection";
import ClientStoriesCarousel    from "./13_ClientStoriesCarousel";

export default function HowWeDoItClient() {
