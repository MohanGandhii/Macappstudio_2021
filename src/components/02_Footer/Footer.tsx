        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/research-and-development" className="text-gray-600 font-medium hover:text-blue-600 transition-colors">
          ...
          <div>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/packages" className="font-semibold text-gray-800 hover:text-blue-600 transition-colors text-base block">
                  Packages
                </Link>
              </li>
              <li>
